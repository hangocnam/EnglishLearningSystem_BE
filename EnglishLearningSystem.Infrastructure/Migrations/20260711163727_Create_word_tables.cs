...
{
    /// <inheritdoc />
    public partial class Create_word_tables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContextExamples", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WordFamilies", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnglistDefinition = table.Column<string>(type: "text", nullable: false),
                    VietnameseMeaning = table.Column<string>(type: "text", nullable: false),
                    WordFamilyId = table.Column<int>(type: "integer", nullable: false),
